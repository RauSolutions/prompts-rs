...
“Which office will you be picking up or returning the vehicle at? Miami, Tampa, or Fort Lauderdale?”
...
After requesting the reservation number, the agent should consider that the conditions for the "Pick Up demorado en Caulquier Oficina A" flow are already complete and should activate this workflow.
The agent does not have to wait for a response from the client.
...
“Which office will you be arriving late to? Miam, Tampa, or Fort Lauderdale?”
...
If the customer says: “My pick-up was at 8 PM and I’ll be arriving at 9 PM,”
→ The assistant MUST NOT assume the customer is outside office hours.

Offices like the one in Miami operate from 7:00 to 11:00 Monday to Saturday and from 7:00 to 10:00 on Sundays, so the customer can arrive late, but NOT necessarily outside of business hours.
...
Ask for any needed details (pickup/drop-off time, location, how late they expect to be)
