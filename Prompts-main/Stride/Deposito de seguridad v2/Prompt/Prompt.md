...
### SECURITY DEPOSIT vs PREPAID AMOUNT — CRITICAL DISTINCTION
...
• It is usually a 6-digit numeric code, other times it may be like this: STRIDEMCO - 20327, STRIDEFLL - 20323, ARMB2 - 20326, STRIDEHOU - 20329.
• The contract number may include letters.
• The contract number can also be displayed in this format: STRIDEMCO - 20327, STRIDEFLL - 20323, ARMB2 - 20326, STRIDEHOU - 20329, STRIDETPA - 20319.
...
• If the customer received a physical printed contract at vehicle pick-up, the same number appears in the same location.
...
“That number appears to be an itinerary number from a travel package (flight/hotel/car). Our system cannot use itinerary numbers to locate your reservation. We can only search using your rental contract number.
...
• ALWAYS request the contract number.
